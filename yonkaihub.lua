if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("Yonkai HubGUI")
          if ui then
              ui:Destroy()
          end
      end
      ...
      function library:AddWindow(text,keybind)
          ...
          DoctorShiba.Name = "Yonkai HubGUI"
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("Yonkai Hub | Bloxfruit!",Enum.KeyCode.RightControl)
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("Yonkai Hub | King Legacy",Enum.KeyCode.RightControl)
      --
